...
namespace FaceLock.EF.Migrations
{
    ...
    [Migration("20230420201552_DoorLockAggregate")]
    partial class DoorLockAggregate
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("FaceLock.Domain.Entities.DoorLockAggregate.DoorLockHistory", b =>
                {
                    ...
                    b.Property<DateTime>("OpenedDateTime")
                        ...
                        .HasDefaultValue(new DateTime(2023, 4, 20, 23, 15, 52, 644, DateTimeKind.Local).AddTicks(1472));
            ...
            modelBuilder.Entity("FaceLock.Domain.Entities.PlaceAggregate.Visit", b =>
                {
                    ...
                    b.Property<DateTime>("CheckInTime")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2023, 4, 20, 23, 15, 52, 647, DateTimeKind.Local).AddTicks(8038));
