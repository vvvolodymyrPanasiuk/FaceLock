...
using FaceLock.EF.MySql.Repositories.DoorLockRepository;
using FaceLock.EF.MySql.Repositories.PlaceRepository;
using FaceLock.EF.MySql.Repositories.UserRepository;
...
namespace FaceLock.EF.MySql.Repositories
{
    public class UnitOfWork : IUnitOfWork
    {
        ...
        public UnitOfWork(
            FaceLockMySqlDbContext context,
